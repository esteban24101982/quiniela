...
<center>
    <table class="table table-condensed">
        ...
        foreach ($this->listaEquipos as $lista => $value) {
            ...
            echo '<a class="btn-sm btn-warning" href="editarEquipo/' . $value['id'] . '">Editar</a>&nbsp;&nbsp;&nbsp;';
            echo '<a class="btn-sm btn-danger" href="eliminarEquipo/' . $value['id'] . '" onclick="return confirm(' . $mensaje .');">Eliminar</a>';
            echo '</td>';
            echo '</tr>';
            $con++;
        }
