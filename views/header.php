...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo URL; ?>public/css/bootstrap-Slate-337.min.css">
                    ...
                    <ul class="nav navbar-nav">
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          ...
                          <li><a href="<?php echo URL; ?>equipo/verEquipos">Ver Equipos</a></li>
                      ...
                      <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Jugador <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="<?php echo URL; ?>jugador/agregarJugador">Agregar Jugador</a></li>
                          <li><a href="<?php echo URL; ?>jugador/verJugadores">Ver Jugadores</a></li>
                          <?php if (Session::get('tipoUsuario') < 2){ ?>
...
<?php endif; ?>
            ...
            <div class="row">
                ...
                <div class="col-xs-1">
                    <img src="<?php echo URL; ?>public/img/quiniela.jpg" alt="Logo Empresa" class="img-rounded pull-left img-responsive">
                </div>
